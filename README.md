...
flowchart LR
    subgraph Input ["Input"]
        ...
        RTL["RTL Design<br/>Files"]
    end
    
    subgraph AI ["AI Orchestration"]
        GPT["GPT-4 Agent<br/>Tool Selection<br/>Parameter Extraction"]
    end
    
    subgraph Flow ["EDA Flow"]
        SYNTH["Synthesis<br/>RTL → Netlist<br/>:13333"]
        PLACE["Placement<br/>Floorplan + Place<br/>:13340"]
        CTS["Clock Tree<br/>CTS + Optimize<br/>:13338"]
        ROUTE["Route & Save<br/>Route + GDS<br/>:13341"]
    end
    ...
    classDef flowStyle fill:#e8f5e8,stroke:#1b5e20,stroke-width:2px
    ...
    class NL,RTL inputStyle
    class GPT aiStyle
    class SYNTH,PLACE,CTS,ROUTE flowStyle
    class GDS,RPT,LOG,TCL outputStyle
    class DC,INNOVUS toolStyle
```
